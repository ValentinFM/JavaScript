...
function mostrarTodasLasTareas(tareas: Tarea[]): void {
...
function mostrarDetallesTarea(tarea: Tarea): void {
...
function filtrarTareasPorEstado(tareas: Tarea[], estado: string): void {
