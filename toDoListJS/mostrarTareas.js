...
const {AtributoEnBlanco,convertirTextoEstado,convertirTextoDificultad,RepetirAtributo,validarFecha,validarInicialDificultad,validarInicialEstado,validarLongitudString } = require("./controles");
...
function editarTarea(tarea) {
    ...
    nuevaDescripcion = prompt(`Nueva descripción (anterior: ${tarea.description}): `);
    ...
    nuevaDescripcion = RepetirAtributo(nuevaDescripcion, tarea.description);
...
module.exports = { filtrarTareasPorEstado, mostrarTodasLasTareas, mostrarDetallesTarea };
